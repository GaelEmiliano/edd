...
public class MonticuloArreglo<T extends ComparableIndexable<T>>
	...
	/* Agregamos los elementos del iterable en el arreglo. */
	for (T e : iterable)
	    agregaEnIndice(e, elementos++);
    }

    private void agregaEnIndice(T elemento, int i) {
	arreglo[i] = elemento;
	...
	T minimo = null;
	for (T e : arreglo)
	    if (minimo == null && e != null)
		minimo = e;
	    else if (e != null &&
		     e.compareTo(minimo) <= 0)
		minimo = e;
